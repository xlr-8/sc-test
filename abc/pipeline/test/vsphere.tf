...
#. terraform_storage_bucket_path (required): abc/test
#+ S3 bucket path in which will be put the Terraform remote state file.
terraform_storage_bucket_path: demo-abc/test

#. config_terraform_path (required): abc/terraform/test
#
# Path of Terraform files in the config git repository
config_terraform_path: abc/terraform/test
