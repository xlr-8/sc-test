...
#. terraform_storage_bucket_path (required): forms2/abc
#+ S3 bucket path in which will be put the Terraform remote state file.
terraform_storage_bucket_path: demo-forms2/abc

#. config_terraform_path (required): forms2/terraform/abc
#
# Path of Terraform files in the config git repository
config_terraform_path: forms2/terraform/abc
