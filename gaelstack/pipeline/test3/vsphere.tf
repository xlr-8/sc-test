...
#. terraform_storage_bucket_path (required): gaelstack/test3
#+ S3 bucket path in which will be put the Terraform remote state file.
terraform_storage_bucket_path: demo-gaelstack/test3

#. config_terraform_path (required): gaelstack/terraform/test3
#
# Path of Terraform files in the config git repository
config_terraform_path: gaelstack/terraform/test3
