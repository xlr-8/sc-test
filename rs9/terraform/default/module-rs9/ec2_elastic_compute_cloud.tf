resource "aws_instance" "FLDqO" {
  ...
  ami                         = var.aws_instance_fldqo_ami
  associate_public_ip_address = true
  availability_zone           = var.aws_instance_fldqo_availability_zone
...
resource "aws_instance" "JgXOn" {
  ...
  ami                         = var.aws_instance_jgxon_ami
  associate_public_ip_address = true
  availability_zone           = var.aws_instance_jgxon_availability_zone
  capacity_reservation_specification {
    capacity_reservation_preference = "open"
  }
  ...
  ebs_optimized                        = var.aws_instance_jgxon_ebs_optimized
...
resource "aws_instance" "QTSGm" {
  ...
  ami                         = var.aws_instance_qtsgm_ami
  associate_public_ip_address = true
  availability_zone           = var.aws_instance_qtsgm_availability_zone
  capacity_reservation_specification {
    capacity_reservation_preference = "open"
  }
  ...
  ebs_optimized                        = var.aws_instance_qtsgm_ebs_optimized
  iam_instance_profile                 = "profile-worker-workers-prod"
  instance_initiated_shutdown_behavior = "terminate"
  instance_type                        = "c5a.4xlarge"
  key_name                             = "cycloid"
...
resource "aws_instance" "QZpjS" {
  ...
  ami                         = var.aws_instance_qzpjs_ami
  associate_public_ip_address = true
  availability_zone           = var.aws_instance_qzpjs_availability_zone
  capacity_reservation_specification {
    capacity_reservation_preference = "open"
  }
  ...
  ebs_optimized                        = var.aws_instance_qzpjs_ebs_optimized
  iam_instance_profile                 = "profile-worker-workers-prod"
  instance_initiated_shutdown_behavior = "terminate"
  instance_type                        = "c5a.4xlarge"
  key_name                             = "cycloid"
...
resource "aws_instance" "aefri" {
  ...
  ami                         = var.aws_instance_aefri_ami
  associate_public_ip_address = true
  availability_zone           = var.aws_instance_aefri_availability_zone
  capacity_reservation_specification {
    capacity_reservation_preference = "open"
  }
...
resource "aws_instance" "cycloidio_website_front_staging" {
  ...
  ami               = var.aws_instance_cycloidio_website_front_staging_ami
  availability_zone = var.aws_instance_cycloidio_website_front_staging_availability_zone
  capacity_reservation_specification {
    capacity_reservation_preference = "open"
  }
...
resource "aws_instance" "fBvpI" {
  ...
  ami               = var.aws_instance_fbvpi_ami
  availability_zone = var.aws_instance_fbvpi_availability_zone
  capacity_reservation_specification {
    capacity_reservation_preference = "open"
  }
