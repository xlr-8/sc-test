...
config_terraform_path: testforms-1/terraform/test
customer: seraf
env: test
...
terraform_storage_bucket_path: demo-testforms-1/test
vsphere_password: ((azure_asmr))
vsphere_server: 195.154.163.200
vsphere_user: ((raw_vaultyness))
