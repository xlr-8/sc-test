...
config_terraform_path: testforms-2/terraform/dev
customer: seraf
env: dev
...
terraform_storage_bucket_path: demo-testforms-2/dev
vsphere_password: ((basic_auth_test1))
vsphere_server: abcdefg
vsphere_user: ((basic_auth_test1))
