...
config_terraform_path: testforms-6/terraform/dev
customer: seraf
env: dev
...
terraform_storage_bucket_path: demo-testforms-6/dev
vsphere_password: ((basic_auth_test1.password))
vsphere_server: 127.0.0.1
vsphere_user: ((basic_auth_test1.username))
