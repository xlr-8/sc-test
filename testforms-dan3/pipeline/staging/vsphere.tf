...
config_terraform_path: testforms-dan3/terraform/staging
customer: seraf
env: staging
...
terraform_storage_bucket_path: demo-testforms-dan3/staging
vsphere_password: ((aws_seraftest))
vsphere_server: testformsdan3
vsphere_user: ((aws_seraftest))
