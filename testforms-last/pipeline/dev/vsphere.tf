...
config_terraform_path: testforms-last/terraform/dev
customer: seraf
env: dev
external_backend_aws_cred_name: aws
project: testforms-last
sc_branch: stacks
...
terraform_storage_bucket_path: demo-testforms-last/dev
vsphere_password: ((aws_dan_aws_cred))
vsphere_server: testforms-vsphere
